...
export class BookFormComponent implements OnInit, OnChanges {
  ...
  // ⚠️ Unterschied zum Buch: Wir setzen den Async-Validator jetzt programmatisch hier im Setter.
  ...
  constructor(
    ...
    this.bookForm = this.fb.group({
      ...
      isbn: ['',
        ...
        // ⚠️ Unterschied zum Buch: Wir setzen den Validator nun immer.
        // Falls das Buch im Edit-Modus ist, wird der Validator im Setter wieder entfernt.
